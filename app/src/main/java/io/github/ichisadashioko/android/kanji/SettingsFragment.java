...
public class SettingsFragment extends PreferenceFragmentCompat
{
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey)
    {
        ...
        EditTextPreference hintTextAlpha = findPreference(getString(R.string.pref_key_hint_text_type_alpha));

        if (hintTextAlpha != null)
        {
            hintTextAlpha.setOnBindEditTextListener(new EditTextPreference.OnBindEditTextListener() {
                @Override
            ...
            hintTextAlpha.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
