...
public class ResultButton extends View {
    ...
    public static String HIRAGANA_CHARS =
            "あいうえおぁぃぅぇぉかきくけこがぎぐげごさしすせそざじずぜぞたちつてとっだぢづでどなにぬねのまみむめもはひふへほばびぶべぼぱぴぷぺぽやゆよゃゅょらりるれろわん";
    public static String KATAKANA_CHARS =
            "アイウエオァィゥェォカキクケコガギグゲゴサシスセソザジズゼゾタチツテトッダヂヅデドナニヌネノマミムメモハヒフヘホバビブベボパピプペポヤユヨャュョラリルレロワンー";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // canvas.drawRect(labelLeft, labelBottom - labelFontSize, labelLeft + labelTextWidth,
        // labelBottom, p);
        // p.setColor(Color.GREEN);
        // canvas.drawRect(confidenceLeft, confidenceBottom - confidenceFontSize, confidenceLeft +
        // confidenceTextWidth, confidenceBottom, p);
        // p.setColor(Color.BLUE);
        // canvas.drawRect(hintTextLeft, hintTextBottom - hintFontSize, hintTextLeft +
        // hintTextWidth, hintTextBottom, p);
